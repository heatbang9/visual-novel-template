...
@export var event_data: Dictionary = {'event_id':'dialogic_000'}
@export var event_color: Color = Color(0.6,0.6,0.6,1)
@export var event_icon: Texture2D

@export var header_scene: PackedScene
@export var body_scene: PackedScene

@export var expand_on_default := false
@export var needs_indentation := false
@export var help_page_path := ""
@export var show_name_in_timeline := true
@export var event_category = 0 # (int, "Main", "Logic", "Timeline", "Audio/Visual", "Godot")
@export var sorting_index: int = -1
