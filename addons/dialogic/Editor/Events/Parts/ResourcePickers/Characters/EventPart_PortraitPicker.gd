...
@export var allow_dont_change := true
@export var allow_definition := true
...
func _ready():
	...
	preview_title.set('theme_override_fonts/font', get_font("title", "EditorFonts"))
	preview.set('theme_override_styles/panel', get_stylebox("panel", "PopupMenu"))
